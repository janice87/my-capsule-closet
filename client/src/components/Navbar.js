...
const Navbar = ({updateCurrentUser}) => {
    ...
    <AppBar position="sticky">
      <Container maxWidth="md">
        ...
        {currentUser ? <Button color="secondary" to="/logout" component={Link} onClick={handleLogout}>LOGOUT</Button>: <Button color="secondary" to="/login" component={Link}>LOGIN</Button>}
